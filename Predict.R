###### Input the following values pro prediction of this day: "Weekday","Sett","Volume1HPM","Return1H","FTD","Beta.3M","Beta4W","Beta2W","Beta1W","BTC","MaxPain","RGME_PD","RAMC_PD","ReturnAMPD"
...
names(datainput)<-c("Weekday","Sett","Volume1HPM","Return1H","FTD","Beta.3M","Beta4W","Beta2W","Beta1W","BTC",
                    "MaxPain","RGME_PD","RAMC_PD","ReturnAMPD")
