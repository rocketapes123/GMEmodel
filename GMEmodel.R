...
lmGME<-lm(ReturnGME~Sett+Volume1HPM+Return1H+FTD+Weekday+Beta.3M+Beta4W+Beta2W+Beta1W+BTC+MaxPain
          +RGME_PD+RAMC_PD+ReturnAMPD+TenYCPD+ReturnSPY+RCTweetPD+RSIPD+SP1H+AMC1H+MACDHISTPD+EarningsPD+VIXPD
          +mPlastPrice+T21+T35
          +GMEFTDPD+ETFFTDPD ### only available until mid of may, exclude for more complete coverage
          , data=data)
